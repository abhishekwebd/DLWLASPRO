<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EngineMaster.aspx.cs" Inherits="DLWLASPRO.EngineMaster" %>
    ...
    <div class="col-xs-12 col-sm-9 content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a><i class="glyphicon glyphicon-list-alt"></i> Engine Master</h3>
            </div>
                        ...
                        <div class="panel-body">
                            <form role="form">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Engine Name</label>
                                    <input type="text" class="form-control" id="txtEngineName" runat="server" placeholder="Enter Engine Name" />
                                </div>
            ...
            <div class="panel-body">
                <div class="content-row">
                    <div class="panel panel-default">
                        <asp:GridView ID="grdEngineMaster" CssClass="table table-hover" runat="server" OnRowEditing="grdEngineMaster_RowEditing" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Engine Name" DataField="Name" HeaderStyle-CssClass="text-center" />
